...
import RFPCanvas from './components/RFPCanvas'
      ...
      if (canAccessDatabase()) {
        ...
        if (user) {
          ...
          if (foundCase) {
            ...
            console.log(`[AUDIT] RFP accessed for case: ${caseId}`)
          }
        }
      }
      setLoading(false)
          ...
          <div className="max-w-2xl mx-auto px-4">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white py-3 rounded-xl hover:from-emerald-700 hover:to-emerald-800 transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isEditingTrialCase ? 'Save Changes' : 'Continue to Requests for Production'}
                  </button>
                  {isEditingTrialCase && (
                    <button
              ...
              <p className="text-xs text-gray-500 text-center mt-6">
                <Link href="/login" className="text-emerald-600 hover:underline">Sign up</Link> to save your work permanently across sessions.
              </p>
            </div>
          </div>
        </section>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      {isTrialMode ? (
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-100">
                    {currentCase.caseNumber ? `Case #: ${currentCase.caseNumber} • ` : ''}Requests for Production
                  </p>
                </div>
              </div>
              <button
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white py-4 shadow-md">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <Link 
                ...
                <div>
                  <h2 className="text-xl font-bold">{currentCase.caseName}</h2>
                  <p className="text-sm text-emerald-100">Case #: {currentCase.caseNumber} • Requests for Production</p>
                </div>
              </div>
              <Link
                href={`/dashboard/cases/${currentCase.id}/discovery`}
                className="text-sm hover:underline text-emerald-100"
              >
                Back to Discovery
              </Link>
            </div>
