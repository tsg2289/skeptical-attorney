...
export default function AIEditChatModal({
      ...
      setMessages([
        {
          id: 'welcome',
          role: 'assistant',
          content: `Hello! I'm here to help you edit the **${sectionTitle}** section.\n\nHow would you like me to revise this content? Here are some suggestions:\n\n• "Make this more aggressive"\n• "Use softer, more diplomatic language"\n• "Emphasize the liability aspects more"\n• "Add more detail about damages"\n• "Make it more concise"\n• "Strengthen the legal citations"\n\nTell me what changes you'd like, and I'll help you refine this section while maintaining accuracy to your case facts.`,
          timestamp: new Date(),
        },
      ]);
    }
  ...
  const quickActions = [
    { label: 'More aggressive', prompt: 'Make this section more aggressive with stronger legal language' },
    { label: 'Less aggressive', prompt: 'Make this section less aggressive with more diplomatic language' },
    { label: 'More concise', prompt: 'Make this section more concise while keeping the key points' },
    { label: 'Add detail', prompt: 'Expand this section with more detail based on the case facts' },
  ];
