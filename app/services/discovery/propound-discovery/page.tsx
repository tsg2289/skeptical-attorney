  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {isTrialMode && (!currentCase || isEditingTrialCase) ? (
        ...
        /* Trial mode with case data - redirect to dashboard discovery pages */
        <section className="py-12">
          <div className="max-w-2xl mx-auto px-4 text-center">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              ...
              <p className="text-gray-600 mb-6">
                Your case information is saved. Choose a discovery type to propound:
              </p>
              <div className="grid grid-cols-2 gap-4">
                <Link
                  href={`/services/discovery/form-interrogatories?caseId=${trialCaseId}`}
                  className="p-4 rounded-xl border-2 border-indigo-200 bg-indigo-50 hover:bg-indigo-100 transition-colors"
                >
                  <div className="font-semibold text-gray-900">Form Interrogatories</div>
                  <div className="text-sm text-gray-600">FROG</div>
                </Link>
                <Link
                  href={`/dashboard/cases/${trialCaseId}/discovery/interrogatories`}
                ...
                <Link
                  href={`/dashboard/cases/${trialCaseId}/discovery/rfp`}
                  className="p-4 rounded-xl border-2 border-emerald-200 bg-emerald-50 hover:bg-emerald-100 transition-colors"
                >
                  <div className="font-semibold text-gray-900">Requests for Production</div>
                  <div className="text-sm text-gray-600">RFP</div>
                </Link>
                <Link
                  href={`/dashboard/cases/${trialCaseId}/discovery/rfa`}
                  className="p-4 rounded-xl border-2 border-amber-200 bg-amber-50 hover:bg-amber-100 transition-colors"
                >
