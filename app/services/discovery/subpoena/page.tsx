    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-white">
          <Header />
          <div className="p-6 text-gray-600">Loading subpoena...</div>
          <Footer />
        </div>
      }
    >
      ...
      if (caseId && !isTrialMode && canAccessDatabase()) {
        ...
        if (user) {
          ...
          if (foundCase) {
            ...
            console.log(`[AUDIT] Subpoena page accessed for case: ${caseId}`)
          }
        }
      } else if (isTrialMode) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold mb-8 leading-tight">
              <span className="gradient-text">Subpoena</span> Generator
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-12 leading-relaxed">
              Create court-ready subpoenas with proper formatting and legal requirements automatically.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="text-center max-w-2xl mx-auto">
              <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-12">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  We&apos;re working hard to bring you the Subpoena Generator. Check back soon!
                </p>
              </div>
            </div>
          </div>
