        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold mb-8 leading-tight">
              <span className="gradient-text">Complaint</span> Generator
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-12 leading-relaxed">
              Create court-ready complaints with proper formatting and legal citations automatically.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="text-center max-w-2xl mx-auto">
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-12">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                We're working hard to bring you the Complaint Generator. Check back soon!
              </p>
            </div>
          </div>
        </div>
